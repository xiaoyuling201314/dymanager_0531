...
public class SysUserDTO implements Serializable {
	...
	public SysUserDTO(String userName, String password, String name,
			String email, Integer state, String department, Integer superAdmin,
			String phone, String comment, String updateTime, String rightList,
			String sessionId) {
		super();
