...
<script type="text/javascript" src="<%=basePath %>js/repair_add_special.js"></script>
...
<%@ include file="/view/include_left_quality.jsp" %>
        ...
        <input type="hidden" name="shipmentNo" />
            ...
            <div class="form-group">
              <label class="form-label col-md-2">SAP代码<strong style="color: red;">*</strong></label>
               <div class="col-md-4" style="height: 38px;">
                <input type="text" class="form-control"  name="sapNo" placeholder="请输入SAP代码">
         ...
         <form enctype="multipart/form-data" id="repairImportform" >
           <input type="hidden" name="operationType" value="special" />
              <div class="form-group" style="height: 38px;">
  ...
  <script src="dist/js/lib/require.min.js" data-main="dist/js/page/repair_add_special.min.js"></script>
</body>
</html>
