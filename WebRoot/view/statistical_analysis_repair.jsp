...
<html>
 ...
 <script type="text/javascript" src="<%=basePath %>js/repair_statics.js"></script>
    ...
    <div class="page-head">
        ...
        <div class="col-md-8" style="margin-left: -15%;">
         <a  class="btn btn-primary" id="colorStyle" href="view/statistical_analysis_ship.jsp">仪器出货统计分析</a>&nbsp;&nbsp;  <!-- class="btn btn-green" -->
          <a class="btn btn-primary" href="view/statistical_analysis_repair.jsp">仪器维修统计分析</a>&nbsp;&nbsp;
          <a class="btn btn-primary" id="colorStyle" href="view/statistical_analysis_repair_percent.jsp">仪器返修率统计分析</a>
        </div>
    ...
    <div class="page-content">
      ...
      <!-- 出货统计分析 -->
       <div style="margin-top: -2%;">
        ...
        <!-- 维修统计分析 -->
       <div style="margin-top: -2%;display: none;">
         <form >
            <label class="form-label col-md-2">统计时间段:</label>
            <select>
              <option>近一个星期</option>
             ...
             <label style="margin-right: 5px;margin-left: 2%;"> 统计时间:</label>  
              <input type="text" onclick="WdatePicker();"  value="<%=nowTime %>" style="width: 150px;" />&nbsp;&nbsp;一一&nbsp;&nbsp;
            <input type="text" onclick="WdatePicker();" value="<%=nowTime %>" style="width: 150px;"/>&nbsp;&nbsp;
            <a class="btn btn-primary"><i class="iconfont icon-search"></i>统计</a>
         </form>
       </div>
        <!-- 返修率统计分析 -->
       <div style="margin-top: -2%;display: none;">
         <form >
            ...
            <select>
           	  <option>请选择</option>
              <option value="week">近一个星期</option>
              <option value="oneMonth">近一个月</option>
              <option value="threeMonth">近三个月</option>
              <option value="oneYear">近一年</option>
            </select>
     ...
     <div style="width: 700px;height: 500px;text-align: center;margin-left: 10%;" id="pic">
        <!--  <img  id="pic" src="" ></img><br/> 
         <label class="staticTotal"></label> -->
     </div>
