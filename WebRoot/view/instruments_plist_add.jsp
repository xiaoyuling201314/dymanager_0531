...
<html>
  ...
  <title>新增 - 装箱清单 - 仪器信息管理系统</title>
  <script type="text/javascript" src="<%=basePath %>js/common.js"></script>
  <script type="text/javascript" src="<%=basePath %>js/instruments_plist_add.js"></script>
   <% request.setAttribute("nav", "instruments_plist"); %>
...
<%@include file="/view/include_left_instruments.jsp" %>
  <div class="main-content instruments">
    <div class="page-head">装箱清单 / 新增</div>
    <div class="page-content">
      <div class="row">
         <form action="packlingService/addPacking.do" method="post" enctype="multipart/form-data" name="plistForm">
          <div class="form-group" style="height: 38px;">
           ...
           <div class="form-group">
            <label class="form-label col-md-3">装箱清单名称<strong style="color: red;">*</strong></label>
            <div class="col-md-5" style="height: 38px;">
              <input type="text" class="form-control" required="required" name="packingListName" placeholder="请输入名称">
              <div class="error" >
              <label style='color: red;position: relative;top:-30px ;left: 103%;' class="packingListNameMessage"  ></label>
            </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-5" style="height: 38px;">
              <input type="text" class="form-control" name="packingListVersion" placeholder="请输入版本号">
               <div class="error" >
              <label style='color: red;position: relative;top:-30px ;left: 103%;' class="packingListVersionMessage"  ></label>
            </div>
            </div>
          </div>
          <div class="form-group">
  ...
  <script src="dist/js/lib/require.min.js" data-main="dist/js/page/instruments_plist_add.min.js"></script>
</body>
</html>
