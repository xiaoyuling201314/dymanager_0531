...
<html>
  <head>
 	<%@ include file="/view/common/head.jsp" %>
  	<title>新增 - 仪器说明书 - 仪器信息管理系统</title>
	 <script type="text/javascript" src="<%=basePath %>js/common.js"></script>
     <script type="text/javascript" src="<%=basePath %>js/document_add.js"></script>
 ...
 <body>
 <% request.setAttribute("nav", "instruments_document"); %>
<%@ include file="/view/common/top.jsp" %>
<%@include file="/view/include_left_instruments.jsp" %>
  <div class="main-content instruments">
    <div class="page-head">仪器设计文档 / 新增</div>
    <div class="page-content">
      <div class="row">
        <form action="documentService/addDocument.do" method="post" enctype="multipart/form-data" name="documentForm">
          <div class="form-group" style="height: 38px;">
            <label class="form-label col-md-3">仪器设计文档文件<strong style="color: red;">*</strong></label>
            <div class="col-md-5" >
              <input type="text" class="form-control" required="required"  name="fileName">
            </div>
              <div class="col-md-4" style="height: 38px;">
              <div class="file-control">
                <input type="file" name="myFile" onchange="selectManualFile();" required="required">浏览...
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-5" style="height: 38px;">
             ...
             <div class="error" >
              <label style='color: red;position: relative;top:-30px ;left: 103%;' class="versionMessage"  ></label>
            </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-5" style="height: 38px;">
              <input type="text" class="form-control"  name="reviser" placeholder="请输入修订人" value="${userSession.userName}">
             <div class="error" >
  ...
  <script src="dist/js/lib/require.min.js" data-main="dist/js/page/instruments_document_add.min.js"></script>
</body>
</html>
