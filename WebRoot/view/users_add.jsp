...
<%@ include file="/view/common/head.jsp" %>
  ...
  <script type="text/javascript" src="<%=basePath %>js/user_add.js"></script>
...
<%@include file="/view/include_left_users.jsp" %>
  <div class="main-content users">
    <div class="page-head">用户列表 / 新增</div>
    <div class="page-content">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <form action="userService/addUser.do" method="post"  class="userForm" onsubmit="return validate();">
          <input type="hidden" name="rightList"/>
            <div class="form-group" style="height: 38px;">
              ...
              <div class="col-md-9" style="height: 38px;">
                <input type="text" class="form-control" name="userName" id="checkUser" data-rule-required="true" placeholder="请输入用户名"><label style="color:red;">${message}</label>
                 <i class="right"><img width='20px' height='20px' style='position: relative;top:-30px ;left: 450px;' src='dist/img/right.png'></img></i>
                ...
                <div class="check" >
	              <label style='color: red;position: relative;top:-30px ;left: 100%;' class="userNameMessage"  ></label>
	            </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <select id="" class="form-control" name="department">
                  ...
                  <option value="仪器信息集成中心">仪器信息集成中心</option>
                </select>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="col-md-offset-5 col-md-6">
                <input type="submit" class="btn btn-green" value="保存" id="saveUserbtn"/>
            ...
            <div class="modal-content">
             ...
             <div class="rights">
              ...
              <div class="modal-action">
                <button type="submit" data-dismiss="modal" class="btn btn-primary" id="setRight" >确定</button><!-- data-dismiss="modal" -->
  ...
  <script src="dist/js/lib/require.min.js" data-main="dist/js/page/users_add.min.js"></script>
