...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath %>js/manual_add.js"></script>
	<script type="text/javascript">
		var basePath = '<%=basePath%>';
	</script>
    <% request.setAttribute("nav", "instruments_manual"); %>
</head>
 <body>
<%@ include file="/view/common/top.jsp" %>
 <%@include file="/view/include_left_instruments.jsp" %>
  <div class="main-content instruments">
    <div class="page-head">仪器说明书 / 新增</div>
    <div class="page-content">
      <div class="row">
        <form action="manualService/addManual.do" method="post" enctype="multipart/form-data" name="manualForm" >
          <div class="form-group" style="height: 38px;">
            <label class="form-label col-md-3">仪器说明书文件<strong style="color: red;">*</strong></label>
            <div class="col-md-5">
  ...
  <script src="dist/js/lib/require.min.js" data-main="dist/js/page/instruments_manual_add.min.js"></script>
</body>
</html>
