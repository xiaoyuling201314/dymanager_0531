...
<script type="text/javascript" src="<%=basePath %>js/ship_statics.js"></script>
  ...
  <div class="main-content instruments">
    <div class="page-head">
        ...
        <div class="col-md-8" style="margin-left: -15%;">
         <a  class="btn btn-primary" href="view/statistical_analysis_ship.jsp" >仪器出货统计分析</a>&nbsp;&nbsp;  <!-- class="btn btn-green" -->
    ...
    <div class="page-content">
     ...
     <div style="width: 78%;height: 200px;text-align: center;margin-left: 10%;" id="pic2">
     </div>
     <div style="display: none;margin-top: 10%;" id="displayMassage">暂无数据
     </div>
    </div>
