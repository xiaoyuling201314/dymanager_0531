...
<html>
  ...
  <title>新增 - 整机BOM单 - 仪器信息管理系统</title>
  <script type="text/javascript" src="<%=basePath %>js/common.js"></script>
  <script type="text/javascript" src="<%=basePath %>js/instruments_complete_bom_add.js"></script>
   <% request.setAttribute("nav", "instruments_complete_bom"); %>
...
<%@include file="/view/include_left_instruments.jsp" %>
  <div class="main-content instruments">
    <div class="page-head">整机BOM单 / 新增</div>
    <div class="page-content">
      <div class="row">
        <form action="completeService/addComplete.do" method="post" enctype="multipart/form-data" name="completeForm">
          ...
          <div class="form-group" >
            <label class="form-label col-md-3">整机BOM单名称<strong style="color: red;">*</strong></label>
            <div class="col-md-5" style="height: 38px;">
              <input type="text" class="form-control" name="completeMachineName" placeholder="请输入名称">
               <div class="error" >
              <label style='color: red;position: relative;top:-30px ;left: 103%;' class="completeMachineNameMessage"  ></label>
            </div>
            </div>
          </div>
          <div class="form-group" >
            ...
            <div class="col-md-5" style="height: 38px;">
              <input type="text" class="form-control" name="completeMachineVersion" placeholder="请输入版本号">
               <div class="error" >
              <label style='color: red;position: relative;top:-30px ;left: 103%;' class="completeMachineVersionMessage"  ></label>
            </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-5"  style="height: 38px;">
              <input type="text" class="form-control" name="createPerson" placeholder="请输入创建人" value="${userSession.userName}">
               <div class="error" >
  ...
  <script src="dist/js/lib/require.min.js" data-main="dist/js/page/instruments_complete_bom_add.min.js"></script>
</body>
</html>
