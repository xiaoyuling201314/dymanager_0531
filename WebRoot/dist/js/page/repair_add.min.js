						...
						$("[name=instrumentFuselage]").on("blur",function(){
							var t=$(this).val();""!=t?$.ajax({url:"repairService/checkShipByFuselage.do",
								...
								{"true"!=e.isExit?($(".error2").attr("style","display:block"),$(".right2").attr("style","display:none"),
										alert("您输入的机身码不存在，请重新输入"),check=false):($(".right2").attr("style","display:block"),$(".error2").attr("style","display:none"),$("[name=sapNo]").val(e.shipMents.sapNo.sapNo),$("[name=productName]").val(e.shipMents.sapNo.productName),$("[name=shipmentNo]").val(e.shipMents.id),$(".sapNoMessage2").html(""),sapNoValue=t,check=true)},
							error:function(){
