require(["../config.min","../base.min"],function(){require(["common/lightbox.min"],function(e){e.run(".gallery")}),require(["common/pagination.min"],
		function(){$("#pagination").pagination({pageCount:pageCount,current:curPage,callback:function(n){var t=n.getCurrent();
		$("#listForm input[name='curPage']").val(t),$("#listForm").submit()}})}),
		  ...
		  require(["common/pagination.min"],
				   function(){$("#paginationSelect").pagination({pageCount:pageCountMateriel,current:curPageMateriel,
					   callback:function(n){var t=n.getCurrent();var materielKeys=$("input[name=materielKeys]").val();$("#listMaterForm input[name='curPage']").val(t),//$("#listMaterForm").submit()
						$.ajax({
						url : "circuitBoardService/selectMateriel.do",
						type : "POST",
						dataType : "json",
		...
		function(e){$(".delete").on("click",function(){
			var cDetailId = $(this).attr("data-id");
			e.confirm("您确定要删除吗？", function() {
				$.ajax({
					url : "circuitBoardService/deleteDetail.do",
					type : "POST",
					data : {
						"cDetailId" : cDetailId,"curPage":curPage
					},
					dataType:"json",
					success : function(data) {
						//alert("删除成功(＾－＾)V");
...
//		 			            	 var serNoright=(serNo+index);
//		 			            	  if(json[index].picture!='' && !json[index].drawings.length>0){
//		 			            		   $("#materForm").append("<tr><td>"+serNoright+"</td> <td>"+json[index].materielNo+"</td> <td>"+json[index].materielTypeId.materielTypeName+"</td> <td class='showMaterielStyle'>"+json[index].materielName+"</td><td class='showMaterielStyle'>"+json[index].modelSpecification+"</td><td>"+json[index].footprint+"</td><td>"+json[index].comment+"</td><td class='gallery'><img width='20px' height='20px' alt='图片' src='dist/img/pic.png'></td><td></td><td style='width: 50px;'> <div class='checkbox' style='margin-right:-5px;'><input type='checkbox' value='"+json[index].materielNo+"' class='for-all"+serNoright+"' name='selectId' onchange='changeallsel(this)'  id='select"+serNoright+"'><label for='select"+serNoright+"' ></label> </div></td> </tr>");
//		 			                   }
//		 			            	   else if(json[index].drawings.length>0 && json[index].picture==''){
//		 			                	   $("#materForm").append("<tr><td>"+serNoright+"</td> <td>"+json[index].materielNo+"</td> <td>"+json[index].materielTypeId.materielTypeName+"</td> <td class='showMaterielStyle'>"+json[index].materielName+"</td><td class='showMaterielStyle'>"+json[index].modelSpecification+"</td><td>"+json[index].footprint+"</td><td>"+json[index].comment+"</td><td></td><td class='viewDrawing'><img width='20px' height='20px' alt='图纸' src='dist/img/draws.png'></td><td style='width: 50px;'> <div class='checkbox' style='margin-right:-5px;'><input type='checkbox' value='"+json[index].materielNo+"' class='for-all"+serNoright+"' name='selectId' onchange='changeallsel(this)'  id='select"+serNoright+"'><label for='select"+serNoright+"' ></label> </div></td> </tr>");
//		 			                   }
//		 			                   else if (json[index].picture!='' && json[index].drawings.length>0){
//		 			                	   $("#materForm").append("<tr><td>"+serNoright+"</td> <td>"+json[index].materielNo+"</td> <td>"+json[index].materielTypeId.materielTypeName+"</td> <td class='showMaterielStyle'>"+json[index].materielName+"</td><td class='showMaterielStyle'>"+json[index].modelSpecification+"</td><td>"+json[index].footprint+"</td><td>"+json[index].comment+"</td><td class='gallery'><img width='20px' height='20px' alt='图片' src='dist/img/pic.png'></td><td class='viewDrawing'><img width='20px' height='20px' alt='图纸' src='dist/img/draws.png'></td><td style='width: 50px;'> <div class='checkbox' style='margin-right:-5px;'><input type='checkbox' value='"+json[index].materielNo+"' class='for-all"+serNoright+"' name='selectId' onchange='changeallsel(this)'  id='select"+serNoright+"'><label for='select"+serNoright+"' ></label> </div></td> </tr>");
//		 			                   }else{
//		 			                	   $("#materForm").append("<tr><td>"+serNoright+"</td> <td>"+json[index].materielNo+"</td> <td>"+json[index].materielTypeId.materielTypeName+"</td> <td class='showMaterielStyle'>"+json[index].materielName+"</td><td class='showMaterielStyle'>"+json[index].modelSpecification+"</td><td>"+json[index].footprint+"</td><td>"+json[index].comment+"</td><td class='gallery'></td><td class='viewDrawing'></td><td style='width: 50px;'> <div class='checkbox' style='margin-right:-5px;'><input type='checkbox' value='"+json[index].materielNo+"' class='for-all"+serNoright+"' name='selectId' onchange='changeallsel(this)'  id='select"+serNoright+"'><label for='select"+serNoright+"' ></label> </div></td> </tr>");
//		 			                   }
//		 			             });
//		 						}
//		 					})
		  			...
		  			//var reg=/^(\w|[.-]|[\u4e00-\u9fa5]|\s){1,255}$/;
		  			 var reg=/^[^*\/\\|:<>?\"]*$/;
		  			    if(fileName!='' && myFile !=''){
		  			     ...
		  			     $.ajax({  
		  			          async: false, 
		  			          url: 'circuitBoardService/importCircuit.do' ,  
		  			          type: 'POST',  
		  			          data: formData, 
		  			          cache: false,  
		  			          processData: false, 
		  			      ...
		  			      //alert("请选择电路板BOM单文件");
		  			    $(".fileNameMessage").html("请选择电路板BOM单文件");
		  			    }
		  			});
		  //BOM单导入功能 start
		});
